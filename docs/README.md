...
Internal notes, architecture decisions, and challenge references.

- [Challenge brief](challenge.md) — full problem statement, scoring criteria, rules
- [Challenge enrichment notes](challenge-enrichment.md) — organiser Q&A, metric clarifications
- [Winning submission plan](winning-submission-plan.md) — architecture design, timeline, risk mitigations
